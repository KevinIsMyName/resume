...
\begin{cventries}
  ...
  {Meta Platforms, Inc. (formerly Facebook)} % Organization
  ...
  {June 2022 -- Sep. 2022} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      ...
      % \item {Created new textures for face and body with similar machine learning technique}
      \item {Rendered and presented visualizations of bodies with PyTorch3D and Blender}
      % \item {Coordinated review of generated body results with research and Zurich team}
