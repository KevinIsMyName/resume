...
\begin{cventries}
  ...
  {June 2022 -- Present} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      \item {Create new 3D models by performing PCA on dataset of \textasciitilde1700 models}
      \item {Outlined model generation goals with XR Fashion team in Zurich}
      \item {Test multiple Facebook Reality Labs product prototypes as a dogfooder}
    \end{cvitems}
  }
  ...
  {Mar. 2021 -- Sep. 2021} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      ...
      \item {Improved webhook functionality of add/edit/create by extending Azure's CLI tool's functionality}
    \end{cvitems}
  }
